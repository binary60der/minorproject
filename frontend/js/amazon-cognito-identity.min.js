  ...
  return (function (e) {
    ...
    function (e, t, n) {
      function r(e, t) {
        ...
        for (
          var r = [], i = t ? e.readInt32BE : e.readInt32LE, o = 0;
          o < e.length;
          o += a
        )
          r.push(i.call(e, o));
      ...
      function i(e, t, n) {
        for (
          var r = new s(t), i = n ? r.writeInt32BE : r.writeInt32LE, o = 0;
          o < e.length;
          o++
        )
          i.call(r, e[o], 4 * o, !0);
    ...
    function (e, t, n) {
      ...
      var s = n(1),
        ...
        v = (function () {
          function e(t) {
            o(this, e),
              (this.N = new h.default(d, 16)),
              (this.g = new h.default("2", 16)),
              (this.k = new h.default(
                this.hexHash(
          ...
          return (
            ...
            (e.prototype.generateHashDevice = function (e, t, n) {
              ...
              var i = "" + e + t + ":" + this.randomPassword,
                o = this.hash(i),
                s = p(16).toString("hex");
              (this.SaltToHashDevices = this.padHex(new h.default(s, 16))),
                this.g.modPow(
                  new h.default(this.hexHash(this.SaltToHashDevices + o), 16),
                  this.N,
                  function (e, t) {
                    e && n(e, null),
            ...
            (e.prototype.calculateA = function (e, t) {
              ...
              this.g.modPow(e, this.N, function (e, r) {
                e && t(e, null),
                  r.mod(n.N).equals(h.default.ZERO) &&
                    t(
            ...
            (e.prototype.computehkdf = function (e, t) {
              var n = l("sha256", t).update(e).digest(),
                r = s.Buffer.concat([
                  this.infoBits,
                  s.Buffer.from(String.fromCharCode(1), "utf8"),
                ]),
            ...
            (e.prototype.getPasswordAuthenticationKey = function (
              ...
              var o = this;
              if (n.mod(this.N).equals(h.default.ZERO))
                throw new Error("B cannot be zero.");
              if (
                ((this.UValue = this.calculateU(this.largeAValue, n)),
                this.UValue.equals(h.default.ZERO))
              )
              ...
              this.calculateS(c, n, function (e, t) {
                e && i(e, null);
                var n = o.computehkdf(
                  s.Buffer.from(o.padHex(t), "hex"),
                  s.Buffer.from(o.padHex(o.UValue.toString(16)), "hex")
                );
                i(null, n);
              });
            }),
    ...
    function (e, t) {
      ...
      function o(e, t, n, r, i, o) {
        for (var s = 32767 & t, a = t >> 15; --o >= 0; ) {
          var u = 32767 & this[e],
            c = this[e++] >> 15,
            h = a * u + c * s;
          (u = s * u + ((32767 & h) << 15) + n[r] + (1073741823 & i)),
            (i = (u >>> 30) + (h >>> 15) + a * c + (i >>> 30)),
            (n[r++] = 1073741823 & u);
        }
        return i;
      }
      ...
      function d(e) {
        ...
        if (s-- > 0)
          for (
            u < this.DB && (n = this[s] >> u) > 0 && ((i = !0), (o = a(n)));
            s >= 0;

          )
            u < t
              ? ((n = (this[s] & ((1 << u) - 1)) << (t - u)),
                (n |= this[--s] >> (u += this.DB - t)))
              : ((n = (this[s] >> (u -= t)) & r),
                u <= 0 && ((u += this.DB), --s)),
              n > 0 && (i = !0),
              i && (o += a(n));
      ...
      function I(e, t, i) {
        ...
        if (!(o.t <= 0)) {
          ...
          if (s.t < o.t)
            return (
              null != t && t.fromInt(0), void (null != i && this.copyTo(i))
            );
          null == i && (i = r());
          var a = r(),
            u = this.s,
          ...
          if (0 != l) {
            ...
            for (; --S >= 0; ) {
              var A =
                i[--y] == l
                  ? this.DM
                  : Math.floor(i[y] * d + (i[y - 1] + v) * g);
              if ((i[y] += a.am(0, A, i, S, 0, f)) < A)
                for (a.dlShiftTo(S, w), i.subTo(w, i); i[y] < --A; )
                  i.subTo(w, i);
            }
            null != t && (i.drShiftTo(f, t), u != c && n.ZERO.subTo(t, t)),
              (i.t = f),
              i.clamp(),
              h > 0 && i.rShiftTo(h, i),
      ...
      function L(e, t, n) {
        ...
        if (((u[1] = a.convert(this)), i > 1)) {
          var p = r();
          for (a.sqrTo(u[1], p); c <= l; )
            (u[c] = r()), a.mulTo(p, u[c - 2], u[c]), (c += 2);
        }
        var d,
          g,
          v = e.t - 1,
        ...
        for (o = m(e[v]) - 1; v >= 0; ) {
          for (
            o >= h
              ? (d = (e[v] >> (o - h)) & l)
              : ((d = (e[v] & ((1 << (o + 1)) - 1)) << (h - o)),
                v > 0 && (d |= e[v - 1] >> (this.DB + o - h))),
              c = i;
            0 == (1 & d);

          )
            (d >>= 1), --c;
          if (((o -= c) < 0 && ((o += this.DB), --v), y))
            u[d].copyTo(s), (y = !1);
          else {
            for (; c > 1; ) a.sqrTo(s, S), a.sqrTo(S, s), (c -= 2);
            c > 0 ? a.sqrTo(s, S) : ((g = s), (s = S), (S = g)),
              a.mulTo(S, u[d], s);
          }
          for (; v >= 0 && 0 == (e[v] & (1 << o)); )
            a.sqrTo(s, S),
      ...
      J && H && "Microsoft Internet Explorer" == navigator.appName
        ? ((n.prototype.am = o), (Y = 30))
        : J && H && "Netscape" != navigator.appName
        ? ((n.prototype.am = i), (Y = 26))
        : ((n.prototype.am = s), (Y = 28)),
        (n.prototype.DB = Y),
        (n.prototype.DM = (1 << Y) - 1),
        (n.prototype.DV = 1 << Y);
      var W = 52;
      (n.prototype.FV = Math.pow(2, W)),
        (n.prototype.F1 = W - Y),
        (n.prototype.F2 = 2 * Y - W);
      var G,
        z,
      ...
      for (G = "A".charCodeAt(0), z = 10; z < 36; ++z) X[G++] = z;
      (x.prototype.convert = O),
        (x.prototype.revert = N),
        (x.prototype.reduce = V),
        (x.prototype.mulTo = q),
        (x.prototype.sqrTo = K),
        ...
        (n.prototype.clamp = p),
        (n.prototype.dlShiftTo = w),
        (n.prototype.drShiftTo = A),
        (n.prototype.lShiftTo = C),
        (n.prototype.rShiftTo = U),
        (n.prototype.subTo = E),
        (n.prototype.multiplyTo = T),
        (n.prototype.squareTo = D),
        (n.prototype.divRemTo = I),
        (n.prototype.invDigit = P),
        (n.prototype.addTo = b),
        (n.prototype.toString = d),
        (n.prototype.negate = g),
        (n.prototype.abs = v),
        (n.prototype.compareTo = y),
        (n.prototype.bitLength = S),
        (n.prototype.mod = R),
        (n.prototype.equals = _),
        (n.prototype.add = k),
        (n.prototype.subtract = F),
        (n.prototype.multiply = B),
        (n.prototype.divide = M),
        (n.prototype.modPow = L),
        (n.ZERO = f(0)),
        (n.ONE = f(1));
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var s = n(1),
        ...
        R = (function () {
          function e(t) {
            if ((o(this, e), null == t || null == t.Username || null == t.Pool))
            ...
            (this.username = t.Username || ""),
              ...
              (this.storage = t.Storage || new D.default().getStorage());
          }
          return (
            ...
            (e.prototype.authenticateUserDefaultAuth = function (e, t) {
              ...
              null != this.deviceKey && (u.DEVICE_KEY = this.deviceKey),
                ...
                r.getLargeAValue(function (c, f) {
                  c && t.onFailure(c),
                    (u.SRP_A = f.toString(16)),
                    "CUSTOM_AUTH" === n.authenticationFlowType &&
                      (u.CHALLENGE_NAME = "SRP_A");
                  var l = {
                  ...
                  n.getUserContextData(n.username) &&
                    (l.UserContextData = n.getUserContextData(n.username)),
                    n.client.request("InitiateAuth", l, function (u, c) {
                      if (u) return t.onFailure(u);
                      var f = c.ChallengeParameters;
                      (n.username = f.USER_ID_FOR_SRP),
                        (o = new h.default(f.SRP_B, 16)),
                        (a = new h.default(f.SALT, 16)),
                              ...
                              u = I("sha256", o)
                                .update(
                                  s.Buffer.concat([
                                    ...
                                    s.Buffer.from(n.username, "utf8"),
                                    s.Buffer.from(f.SECRET_BLOCK, "base64"),
                                    s.Buffer.from(a, "utf8"),
                                  ])
                                )
                                .digest("base64"),
                              h = {};
                            (h.USERNAME = n.username),
                              (h.PASSWORD_CLAIM_SECRET_BLOCK = f.SECRET_BLOCK),
                              (h.TIMESTAMP = a),
                              (h.PASSWORD_CLAIM_SIGNATURE = u),
                              null != n.deviceKey &&
                                (h.DEVICE_KEY = n.deviceKey);
                            var l = function e(t, r) {
                                return n.client.request(
                                  "RespondToAuthChallenge",
                                  t,
                                  function (i, o) {
                                    return i &&
                                      "ResourceNotFoundException" === i.code &&
                                      i.message
                                        .toLowerCase()
                                        .indexOf("device") !== -1
                                      ? ((h.DEVICE_KEY = null),
                              ...
                              l(p, function (e, i) {
                                ...
                                if ("NEW_PASSWORD_REQUIRED" === o) {
                                  ...
                                  var s = null,
                                    ...
                                    u = [],
                                    c =
                                      r.getNewPasswordRequiredChallengeUserAttributePrefix();
                                  if (
                                    (i.ChallengeParameters &&
                                      ((s = JSON.parse(
                                        i.ChallengeParameters.userAttributes
                                      )),
                                      (a = JSON.parse(
                                        i.ChallengeParameters.requiredAttributes
                                      ))),
                                    a)
                                  )
                                    for (var h = 0; h < a.length; h++)
                                      u[h] = a[h].substr(c.length);
            ...
            (e.prototype.authenticateUserPlainUsernamePassword = function (
              e,
              t
            ) {
              var n = this,
              ...
              this.getUserContextData(this.username) &&
                (o.UserContextData = this.getUserContextData(this.username)),
              ...
              return null == a
                ...
                : void t.generateHashDevice(
                    ...
                    function (i) {
                      ...
                      var o = {
                        Salt: s.Buffer.from(t.getSaltDevices(), "hex").toString(
                          "base64"
                        ),
                        PasswordVerifier: s.Buffer.from(
                          t.getVerifierDevices(),
                          "hex"
                        ).toString("base64"),
                      };
                      (r.verifierDevices = o.PasswordVerifier),
                        (r.deviceGroupKey = a.DeviceGroupKey),
              ...
              this.getUserContextData() &&
                ...
                this.client.request(
                  ...
                  function (e, t) {
                    return e
                      ? n.onFailure(e)
                      : r.authenticateUserInternal(t, i, n);
                  }
                );
            }),
              ...
              (i.USERNAME = this.username),
                ...
                n.getLargeAValue(function (o, a) {
                  ...
                  t.getUserContextData() &&
                    (u.UserContextData = t.getUserContextData()),
                    t.client.request(
                      "RespondToAuthChallenge",
                      u,
                      function (i, o) {
                          ...
                          function (n, i) {
                            ...
                            var u = r.getNowString(),
                              c = I("sha256", i)
                                .update(
                                  s.Buffer.concat([
                                    s.Buffer.from(t.deviceGroupKey, "utf8"),
                                    s.Buffer.from(t.deviceKey, "utf8"),
                                    s.Buffer.from(a.SECRET_BLOCK, "base64"),
                                    s.Buffer.from(u, "utf8"),
                                  ])
                                )
                                .digest("base64"),
                              h = {};
                            (h.USERNAME = t.username),
                              (h.PASSWORD_CLAIM_SECRET_BLOCK = a.SECRET_BLOCK),
                              (h.TIMESTAMP = u),
                              (h.PASSWORD_CLAIM_SIGNATURE = c),
                              (h.DEVICE_KEY = t.deviceKey);
                            var f = {
                            ...
                            t.getUserContextData() &&
                              (f.UserContextData = t.getUserContextData()),
                              t.client.request(
                                "RespondToAuthChallenge",
                                f,
                                function (n, r) {
            ...
            (e.prototype.confirmRegistration = function (e, t, n) {
              ...
              this.getUserContextData() &&
                ...
                this.client.request("ConfirmSignUp", r, function (e) {
            ...
            (e.prototype.sendMFACode = function (e, t, n) {
              ...
              var o = n || "SMS_MFA";
              "SOFTWARE_TOKEN_MFA" === o && (i.SOFTWARE_TOKEN_MFA_CODE = e),
              ...
              this.getUserContextData() &&
                ...
                this.client.request(
                  ...
                  function (e, n) {
                    ...
                    if ("DEVICE_SRP_AUTH" === i)
                      return void r.getDeviceResponse(t);
                    if (
                      ...
                      return t.onSuccess(r.signInUserSession);
                    ...
                    o.generateHashDevice(
                      ...
                      function (e) {
                        ...
                        (r.verifierDevices = i.PasswordVerifier),
                          (r.deviceGroupKey =
                            n.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey),
                          (r.randomPassword = o.getRandomPassword()),
                          r.client.request(
                            "ConfirmDevice",
                            {
                              DeviceKey:
            ...
            (e.prototype.getSession = function (e) {
              ...
              if (this.storage.getItem(n)) {
                var s = new v.default({ IdToken: this.storage.getItem(n) }),
                  a = new d.default({ AccessToken: this.storage.getItem(r) }),
                  u = new m.default({ RefreshToken: this.storage.getItem(i) }),
            ...
            (e.prototype.refreshSession = function (e, t) {
              ...
              this.getUserContextData() &&
                (a.UserContextData = this.getUserContextData()),
                this.client.request("InitiateAuth", a, function (r, i) {
                  if (r)
                    return (
                      "NotAuthorizedException" === r.code &&
                        n.clearCachedTokens(),
                      t(r, null)
                    );
                  if (i) {
            ...
            (e.prototype.getCognitoUserSession = function (e) {
              var t = new v.default(e),
                n = new d.default(e),
                r = new m.default(e),
                i = { IdToken: t, AccessToken: n, RefreshToken: r };
            ...
            (e.prototype.forgotPassword = function (e) {
              ...
              this.getUserContextData() &&
                ...
                this.client.request("ForgotPassword", t, function (t, n) {
                  return t
                    ? e.onFailure(t)
            ...
            (e.prototype.confirmPassword = function (e, t, n) {
              ...
              this.getUserContextData() &&
                (r.UserContextData = this.getUserContextData()),
                this.client.request("ConfirmForgotPassword", r, function (e) {
      ...
      var r = (function () {
        function e() {
          var t =
            ...
            o = t.AccessToken,
            s = t.ClockDrift;
          if ((n(this, e), null == o || null == r))
            throw new Error("Id token and Access Token must be present.");
          (this.idToken = r),
            (this.refreshToken = i),
            (this.accessToken = o),
            (this.clockDrift = void 0 === s ? this.calculateClockDrift() : s);
        }
        return (
    ...
    function (e, t, n) {
      function r(e, t, n) {
        a.isBuffer(t) || (t = new a(t)),
          ...
          t.length > p ? (t = e(t)) : t.length < p && (t = a.concat([t, d], p));
        for (var r = new a(p), i = new a(p), o = 0; o < p; o++)
      ...
      function i(e, t) {
        ...
        var n = l[e],
          ...
          s = 0;
        return (
          n || o("algorithm:", e, "is not yet supported"),
          {
            update: function (e) {
              return (
    ...
    function (e, t) {
      ...
      function o(e) {
        for (
          ...
          (t =
            (h[e.charCodeAt(l)] << 18) |
            (h[e.charCodeAt(l + 1)] << 12) |
            (h[e.charCodeAt(l + 2)] << 6) |
            h[e.charCodeAt(l + 3)]),
            (a[u++] = (t >> 16) & 255),
            (a[u++] = (t >> 8) & 255),
            (a[u++] = 255 & t);
        return (
          2 === s &&
            ((t = (h[e.charCodeAt(l)] << 2) | (h[e.charCodeAt(l + 1)] >> 4)),
            (a[u++] = 255 & t)),
          1 === s &&
            ((t =
              (h[e.charCodeAt(l)] << 10) |
              (h[e.charCodeAt(l + 1)] << 4) |
              (h[e.charCodeAt(l + 2)] >> 2)),
            (a[u++] = (t >> 8) & 255),
            (a[u++] = 255 & t)),
          a
        );
      ...
      function u(e) {
        for (
          var t, n = e.length, r = n % 3, i = [], o = 16383, s = 0, u = n - r;
          s < u;
          s += o
        )
          i.push(a(e, s, s + o > u ? u : s + o));
        return (
          1 === r
              ...
              for (
                ...
                try {
                  ...
                  if (
                    ((d = n.read
                      ? n.read(d, g)
                      : n(d, g) || d.replace(f, decodeURIComponent)),
                    this.json)
                  )
                    try {
                      d = JSON.parse(d);
      ...
      var o = n(23),
        ...
        a = (function () {
          function e(t, n) {
            i(this, e),
              (this.endpoint =
                n || "https://cognito-idp." + t + ".amazonaws.com/"),
              (this.userAgent =
                s.default.prototype.userAgent || "aws-amplify/0.1.x js");
          }
          return (
            (e.prototype.request = function (e, t, n) {
              ...
              fetch(this.endpoint, i)
                ...
                .catch(function (e) {
                  var t = { code: "UnknownError", message: "Unkown error" };
      ...
      var o = n(20),
        ...
        f = (function () {
          function e(t) {
            ...
            (this.userPoolId = r),
              (this.clientId = o),
              (this.client = new s.default(c, a)),
              (this.advancedSecurityDataCollectionFlag = u !== !1),
              (this.storage = t.Storage || new h.default().getStorage());
          }
          return (
            ...
            (e.prototype.signUp = function (e, t, n, r, i) {
              ...
              this.getUserContextData(e) &&
                (s.UserContextData = this.getUserContextData(e)),
    ...
    function (e, t) {
      ...
      (t.__esModule = !0),
        (t.default = n),
        (n.prototype.userAgent = "aws-amplify/0.1.x js");
    },
    function (e, t, n) {
      function r(e, t) {
        ...
        for (
          ...
          var l = n,
            ...
            d = i,
            g = h;
          (n = o(n, r, i, h, e[f + 0], 7, -680876936)),
            (h = o(h, n, r, i, e[f + 1], 12, -389564586)),
            (i = o(i, h, n, r, e[f + 2], 17, 606105819)),
            (r = o(r, i, h, n, e[f + 3], 22, -1044525330)),
            (n = o(n, r, i, h, e[f + 4], 7, -176418897)),
            (h = o(h, n, r, i, e[f + 5], 12, 1200080426)),
            (i = o(i, h, n, r, e[f + 6], 17, -1473231341)),
            (r = o(r, i, h, n, e[f + 7], 22, -45705983)),
            (n = o(n, r, i, h, e[f + 8], 7, 1770035416)),
            (h = o(h, n, r, i, e[f + 9], 12, -1958414417)),
            (i = o(i, h, n, r, e[f + 10], 17, -42063)),
            (r = o(r, i, h, n, e[f + 11], 22, -1990404162)),
            (n = o(n, r, i, h, e[f + 12], 7, 1804603682)),
            (h = o(h, n, r, i, e[f + 13], 12, -40341101)),
            (i = o(i, h, n, r, e[f + 14], 17, -1502002290)),
            (r = o(r, i, h, n, e[f + 15], 22, 1236535329)),
            (n = s(n, r, i, h, e[f + 1], 5, -165796510)),
            (h = s(h, n, r, i, e[f + 6], 9, -1069501632)),
            (i = s(i, h, n, r, e[f + 11], 14, 643717713)),
            (r = s(r, i, h, n, e[f + 0], 20, -373897302)),
            (n = s(n, r, i, h, e[f + 5], 5, -701558691)),
            (h = s(h, n, r, i, e[f + 10], 9, 38016083)),
            (i = s(i, h, n, r, e[f + 15], 14, -660478335)),
            (r = s(r, i, h, n, e[f + 4], 20, -405537848)),
            (n = s(n, r, i, h, e[f + 9], 5, 568446438)),
            (h = s(h, n, r, i, e[f + 14], 9, -1019803690)),
            (i = s(i, h, n, r, e[f + 3], 14, -187363961)),
            (r = s(r, i, h, n, e[f + 8], 20, 1163531501)),
            (n = s(n, r, i, h, e[f + 13], 5, -1444681467)),
            (h = s(h, n, r, i, e[f + 2], 9, -51403784)),
            (i = s(i, h, n, r, e[f + 7], 14, 1735328473)),
            (r = s(r, i, h, n, e[f + 12], 20, -1926607734)),
            (n = a(n, r, i, h, e[f + 5], 4, -378558)),
            (h = a(h, n, r, i, e[f + 8], 11, -2022574463)),
            (i = a(i, h, n, r, e[f + 11], 16, 1839030562)),
            (r = a(r, i, h, n, e[f + 14], 23, -35309556)),
            (n = a(n, r, i, h, e[f + 1], 4, -1530992060)),
            (h = a(h, n, r, i, e[f + 4], 11, 1272893353)),
            (i = a(i, h, n, r, e[f + 7], 16, -155497632)),
            (r = a(r, i, h, n, e[f + 10], 23, -1094730640)),
            (n = a(n, r, i, h, e[f + 13], 4, 681279174)),
            (h = a(h, n, r, i, e[f + 0], 11, -358537222)),
            (i = a(i, h, n, r, e[f + 3], 16, -722521979)),
            (r = a(r, i, h, n, e[f + 6], 23, 76029189)),
            (n = a(n, r, i, h, e[f + 9], 4, -640364487)),
            (h = a(h, n, r, i, e[f + 12], 11, -421815835)),
            (i = a(i, h, n, r, e[f + 15], 16, 530742520)),
            (r = a(r, i, h, n, e[f + 2], 23, -995338651)),
            (n = u(n, r, i, h, e[f + 0], 6, -198630844)),
            (h = u(h, n, r, i, e[f + 7], 10, 1126891415)),
            (i = u(i, h, n, r, e[f + 14], 15, -1416354905)),
            (r = u(r, i, h, n, e[f + 5], 21, -57434055)),
            (n = u(n, r, i, h, e[f + 12], 6, 1700485571)),
            (h = u(h, n, r, i, e[f + 3], 10, -1894986606)),
            (i = u(i, h, n, r, e[f + 10], 15, -1051523)),
            (r = u(r, i, h, n, e[f + 1], 21, -2054922799)),
            (n = u(n, r, i, h, e[f + 8], 6, 1873313359)),
            (h = u(h, n, r, i, e[f + 15], 10, -30611744)),
            (i = u(i, h, n, r, e[f + 6], 15, -1560198380)),
            (r = u(r, i, h, n, e[f + 13], 21, 1309151649)),
            (n = u(n, r, i, h, e[f + 4], 6, -145523070)),
            (h = u(h, n, r, i, e[f + 11], 10, -1120210379)),
            (i = u(i, h, n, r, e[f + 2], 15, 718787259)),
            (r = u(r, i, h, n, e[f + 9], 21, -343485551)),
            (n = c(n, l)),
            (r = c(r, p)),
            (i = c(i, d)),
            (h = c(h, g));
      ...
      function r(e, t) {
        ...
        for (
          ...
          for (var p = r, d = u, g = c, v = h, y = f, m = 0; m < 80; m++) {
            m < 16
              ? (n[m] = e[l + m])
              : (n[m] = a(n[m - 3] ^ n[m - 8] ^ n[m - 14] ^ n[m - 16], 1));
          ...
          for (var y = 0; y < e.length; y += 16) {
            ...
            for (var m = 0; m < 64; m++)
              m < 16
                ? (U[m] = e[m + y])
                : (U[m] = i(
                    i(i(l(U[m - 2]), U[m - 7]), f(U[m - 15])),
                    U[m - 16]
                  )),
                (S = i(i(i(i(v, h(p)), a(p, d, g)), A[m]), U[m])),
                (w = i(c(n), u(n, r, o))),
                (v = g),
                (g = d),
                (d = p),
